...
import { collection, query, where, orderBy, Timestamp, getDocs, addDoc, doc, setDoc, getDoc, updateDoc } from 'firebase/firestore';
...
export async function getPaymentMethods(householdId: string): Promise<PaymentMethod[]> {
