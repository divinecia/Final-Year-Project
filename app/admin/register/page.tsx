  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
        ...
        if (result.success) {
            ...
            // Redirect to a page showing all admins, e.g., settings
                ...
                <Form {...form}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormField
                            ...
                            name="employeeId"
                            render={({ field }) => (
                            <FormItem><FormLabel>Employee ID</FormLabel><FormControl><Input placeholder="e.g. HH-001" {...field} /></FormControl><FormMessage /></FormItem>
                            )}
                        />
                    </div>
                    ...
                    <FormField
                        ...
                        name="email"
                        render={({ field }) => (
                        <FormItem><FormLabel>Official Email</FormLabel><FormControl><Input type="email" placeholder="name@househelp.app" {...field} /></FormControl><FormMessage /></FormItem>
                        )}
                    />
                     <FormField
                        control={form.control}
                        name="phone"
                        render={({ field }) => (
                        <FormItem><FormLabel>Phone Number</FormLabel><FormControl><Input type="tel" placeholder="07..." {...field} /></FormControl><FormMessage /></FormItem>
                        )}
                    />
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                    ...
                    <div className="flex justify-between items-center pt-4">
                        <Button variant="outline" asChild><Link href="/admin/settings">Cancel</Link></Button>
